...
const Video = require('app/models/videoForModules');
...
class videoModulesController {
    ...
    async createVideo(req, res) {
        try {
            ...
            const articles = await Modules.find();
            const videos = await Video.find();
            res.render('admin/videosModules/create', { title, articles, videos, massages: req.flash('errors') });
        } catch (error) {
            console.log(error)
        }
    }
